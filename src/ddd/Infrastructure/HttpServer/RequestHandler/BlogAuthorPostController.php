...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .back-to-blog { display: inline-block; margin-bottom: 1.25rem; font-size: 1.2rem; font-weight: 600; color: var(--keyword); text-decoration: none; padding: 0.4rem 1rem; border: 2px solid var(--keyword); border-radius: 6px; transition: all 0.2s; }
        .back-to-blog:hover { background: var(--keyword); color: var(--bg1); }
...
<body>
    <article>
        <header>
            <a href="/blog" class="back-to-blog">&larr; Blog</a>
            <h1>{$title}</h1>
