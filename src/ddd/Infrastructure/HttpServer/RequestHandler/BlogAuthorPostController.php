...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .back-to-blog-wrap { text-align: center; margin-bottom: 1.25rem; }
        .back-to-blog { font-size: 1rem; font-weight: 700; color: #fff; text-decoration: none; padding: 0.6rem 1.5rem; background: linear-gradient(135deg, var(--keyword), var(--func)); border: none; border-radius: 20px; transition: all 0.3s; letter-spacing: 0.03em; display: inline-block; }
