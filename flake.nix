      ...
      perSystem = { config, self', inputs', pkgs, system, lib, ... }:
        let
          php = pkgs.api.buildPhpFromComposer {
            src = inputs.self;
            php =
              pkgs.php83; # Change to php56, php70, ..., php81, php82, php83 etc.
          };
        in {
          ...
          checks = { inherit (self'.packages) drupal satis symfony-demo; };
          ...
          packages = {
            satis = php.buildComposerProject {
              ...
              vendorHash =
                "sha256-YA5UIlGhRVdkz+NFiujGRkb9Zx8Up4IEOmco1rEOkGk=";
            ...
            drupal = php.buildComposerProject {
              ...
              vendorHash =
                "sha256-39cCLG4x8/C9XZG2sOCpxO1HUsqt3DduCMMIxPCursw=";
            };
            ...
            symfony-demo = php.buildComposerProject {
              ...
              vendorHash =
                "sha256-Nv9pRQJ2Iij1IxPNcCk732Q79FWB/ARJRvjPVVyLMEc=";
            };
            ...
            apps = {
              mezzio-skeleton = {
                ...
                program = lib.getExe (pkgs.writeShellApplication {
                  ...
                  text = ''
                    ${
                      lib.getExe php
                    } -S 0.0.0.0:8080 -t ${self'.packages.mezzio}/share/php/${self'.packages.mezzio.pname}/public/
                  '';
                });
              };
              ...
              symfony-demo = {
                ...
                program = lib.getExe (pkgs.writeShellApplication {
                  ...
                  text = ''
                    ...
                    ${
                      lib.getExe pkgs.symfony-cli
                    } serve --document-root ${self'.packages.symfony-demo}/share/php/symfony-demo/public --allow-http
                  '';
                });
              };
              ...
              composer = {
                ...
                program = lib.getExe (pkgs.writeShellApplication {
                  ...
                  runtimeInputs = [ php php.packages.composer ];
              ...
              phpstan = {
                ...
                program = lib.getExe (pkgs.writeShellApplication {
                  ...
                  runtimeInputs = [ php php.packages.phpstan ];
              ...
              psalm = {
                ...
                program = lib.getExe (pkgs.writeShellApplication {
                  ...
                  runtimeInputs = [ php php.packages.psalm ];
